...
vault write secret/user-read-service spring.datasource.url=jdbc:postgresql://localhost:5433/last-civilization_db \ spring.datasource.username=last-civilization \ spring.datasource.password=last-civilization
vault write secret/user-write-service spring.datasource.url=jdbc:postgresql://localhost:5432/last-civilization_db \ spring.datasource.username=last-civilization \ spring.datasource.password=last-civilization  \ spring.rabbitmq.host=localhost \ spring.rabbitmq.port=5672 \ spring.rabbitmq.username=last-civilization \ spring.rabbitmq.password=last-civilization
vault write secret/payment-read-service spring.datasource.url=jdbc:postgresql://localhost:5433/last-civilization_db \ spring.datasource.username=last-civilization \ spring.datasource.password=last-civilization
vault write secret/payment-write-service spring.datasource.url=jdbc:postgresql://localhost:5432/last-civilization_db \ spring.datasource.username=last-civilization \ spring.datasource.password=last-civilization
vault write secret/stats-read-service spring.datasource.url=jdbc:postgresql://localhost:5433/last-civilization_db \ spring.datasource.username=last-civilization \ spring.datasource.password=last-civilization
