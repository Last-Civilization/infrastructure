...
vault write secret/equipment-read-service spring.datasource.url=jdbc:postgresql://localhost:5441/last-civilization_equipment_db \ spring.datasource.username=last-civilization \ spring.datasource.password=last-civilization
vault write secret/equipment-write-service spring.datasource.url=jdbc:postgresql://localhost:5440/last-civilization_equipment_db \ spring.datasource.username=last-civilization \ spring.datasource.password=last-civilization \ backpack.size=20